...
![](http://res.cloudinary.com/lesswrong-2-0/image/upload/v1672577367/mirroredImages/i3BTagvt3HbPMx6PN/quqsoo5xeq4clo0wzjcf.png)
...
![](http://res.cloudinary.com/lesswrong-2-0/image/upload/v1672577367/mirroredImages/i3BTagvt3HbPMx6PN/phxwtbigjjp0zwfd5rmb.png)
...
![](http://res.cloudinary.com/lesswrong-2-0/image/upload/v1672577367/mirroredImages/i3BTagvt3HbPMx6PN/efeeabln9ppxecftwtgg.png)
...
![](http://res.cloudinary.com/lesswrong-2-0/image/upload/v1672577367/mirroredImages/i3BTagvt3HbPMx6PN/is5usvgp5ejqcqq79gu2.png)

For example, because the agent is smaller than the environment, there can be other copies of the agent, or things very similar to the agent. This leads to contentious decision-theory problems such as [the Twin Prisoner's Dilemma and Newcomb's problem](https://intelligence.org/2017/10/22/fdt/).
...
![](http://res.cloudinary.com/lesswrong-2-0/image/upload/v1672577367/mirroredImages/i3BTagvt3HbPMx6PN/de3wabrs4lzfvjaymuvp.png)
...
The proof that this is so is by [Löb's theorem](http://intelligence.org/files/lob-notes-IAFF.pdf). Löb's theorem says that, for any proposition P, if you can prove that a *proof* of P would imply the *truth* of P, then you can prove P. In symbols, with "□X" meaning "X is provable":
...
![](http://res.cloudinary.com/lesswrong-2-0/image/upload/v1672577367/mirroredImages/i3BTagvt3HbPMx6PN/spuy1gthqfb9ntfkdual.png)

Suppose the interviewer is an amazing judge of character—or just has read access to your source code.

![](http://res.cloudinary.com/lesswrong-2-0/image/upload/v1672577367/mirroredImages/i3BTagvt3HbPMx6PN/klupmlvptr1gzkfavt3l.png)
...
![](http://res.cloudinary.com/lesswrong-2-0/image/upload/v1672577367/mirroredImages/i3BTagvt3HbPMx6PN/ru1iuejeifv4z5wjgkyz.png)

But stealing is clearly a bad idea *as a normal action*, because you’ll be seen as much less reliable and trustworthy.

![](http://res.cloudinary.com/lesswrong-2-0/image/upload/v1672577367/mirroredImages/i3BTagvt3HbPMx6PN/o95uuevgqqvuftldx3kk.png)
...
![](http://res.cloudinary.com/lesswrong-2-0/image/upload/v1672577367/mirroredImages/i3BTagvt3HbPMx6PN/n1mnysycp7qmtg00uyje.png)
...
![](http://res.cloudinary.com/lesswrong-2-0/image/upload/v1672577367/mirroredImages/i3BTagvt3HbPMx6PN/h4cj8uz9suxadmuio7vq.png)
...
![](http://res.cloudinary.com/lesswrong-2-0/image/upload/v1672577367/mirroredImages/i3BTagvt3HbPMx6PN/zghbjkjskg6e9buz0cmc.png)
...
![](http://res.cloudinary.com/lesswrong-2-0/image/upload/v1672577367/mirroredImages/i3BTagvt3HbPMx6PN/nyvn5n8y2kgggwrqpow2.png)
...
![](http://res.cloudinary.com/lesswrong-2-0/image/upload/v1672577367/mirroredImages/i3BTagvt3HbPMx6PN/kesx0aysj0gjray9e3cz.png)
...
![](http://res.cloudinary.com/lesswrong-2-0/image/upload/v1672577367/mirroredImages/i3BTagvt3HbPMx6PN/ylccwo8nsud1agkgmzkl.png)
...
![](http://res.cloudinary.com/lesswrong-2-0/image/upload/v1672577367/mirroredImages/i3BTagvt3HbPMx6PN/puievera5xw19vkikzed.png)
...
![](http://res.cloudinary.com/lesswrong-2-0/image/upload/v1672577367/mirroredImages/i3BTagvt3HbPMx6PN/dol963ho5mnizxjvltvy.png)
...
![](http://res.cloudinary.com/lesswrong-2-0/image/upload/v1672577367/mirroredImages/i3BTagvt3HbPMx6PN/ujxnlen6u0eihqwix9qf.png)
...
![](http://res.cloudinary.com/lesswrong-2-0/image/upload/v1672577367/mirroredImages/i3BTagvt3HbPMx6PN/fdcgjbwecrakmrov0bwk.png)
...
![](http://res.cloudinary.com/lesswrong-2-0/image/upload/v1672577367/mirroredImages/i3BTagvt3HbPMx6PN/l9llchlyl0g5zgbx45kc.png)
...
![](http://res.cloudinary.com/lesswrong-2-0/image/upload/v1672577367/mirroredImages/i3BTagvt3HbPMx6PN/puwnrkmgdxzctjqehxzq.png)
...
![](http://res.cloudinary.com/lesswrong-2-0/image/upload/v1672577367/mirroredImages/i3BTagvt3HbPMx6PN/dsopnchstdjtlt3wr2if.png)
...
![](http://res.cloudinary.com/lesswrong-2-0/image/upload/v1672577367/mirroredImages/i3BTagvt3HbPMx6PN/xsntwhyhw4iphnba0cuv.png)
...
![](http://res.cloudinary.com/lesswrong-2-0/image/upload/v1672577367/mirroredImages/i3BTagvt3HbPMx6PN/hiwjlusx0m0t40odh2bj.png)
...
![](http://res.cloudinary.com/lesswrong-2-0/image/upload/v1672577367/mirroredImages/i3BTagvt3HbPMx6PN/wu8rkdgc5krfoncplqxn.png)
...
![](http://res.cloudinary.com/lesswrong-2-0/image/upload/v1672577367/mirroredImages/i3BTagvt3HbPMx6PN/ulf4xie2t1svbte3fvxq.png)
...
For a Bayesian, the scales of probability are balanced in precisely such a way that [no Dutch book](https://www.lesswrong.com/w/expected_utility_formalism?l=7hh) can be made against them—no sequence of bets that are a sure loss. But you can only account for all Dutch books if you know all the consequences of your beliefs. Absent that, someone who has explored other parts of the tree can Dutch-book you.
...
Another consequence of the fact that the world is bigger than you is that you need to be able to use [**high-level world models**](https://www.lesswrong.com/w/ontology_identification): models which involve things like tables and chairs.

This is related to the classical symbol grounding problem; but since we want a formal analysis which increases our trust in some system, the kind of model which interests us is somewhat different. This also relates to transparency and [informed oversight](https://ai-alignment.com/the-informed-oversight-problem-1b51b4f66b35): world-models should be made out of understandable parts.
...
![](http://res.cloudinary.com/lesswrong-2-0/image/upload/v1672577367/mirroredImages/i3BTagvt3HbPMx6PN/nx4wc7ku1txlqotqcwax.png)
...
![](http://res.cloudinary.com/lesswrong-2-0/image/upload/v1672577367/mirroredImages/i3BTagvt3HbPMx6PN/zbq8ylqwljbyzc0hfb90.png)
...
![](http://res.cloudinary.com/lesswrong-2-0/image/upload/v1672577367/mirroredImages/i3BTagvt3HbPMx6PN/s2yamcigzhsqysui0gzd.png)
...
- [value loading](http://intelligence.org/files/ValueLearningProblem.pdf)
...
![](http://res.cloudinary.com/lesswrong-2-0/image/upload/v1672577367/mirroredImages/i3BTagvt3HbPMx6PN/qnm0iuuitg2peximfgvb.png)
...
![](http://res.cloudinary.com/lesswrong-2-0/image/upload/v1672577367/mirroredImages/i3BTagvt3HbPMx6PN/wvrfdo2jox5cxqb1pete.png)

For example, updateless decision theory eliminates dynamic inconsistencies in decision theory by, rather than maximizing expected utility of your action *given* what you know, maximizing expected utility *of reactions* to observations, from a state of [ignorance](https://intelligence.org/wp-content/uploads/2018/11/Predecessor-and-Successor-Goals.png).
...
When you construct another agent, rather than delegating to your future self, you more directly face a problem of [**value loading**](http://intelligence.org/files/ValueLearningProblem.pdf).

#### 4.2. Goodhart's law

The main problems in the context of value loading:

- We [don't know](https://www.lesswrong.com/w/complexity_of_value) what we want.
...
![](http://res.cloudinary.com/lesswrong-2-0/image/upload/v1672577367/mirroredImages/i3BTagvt3HbPMx6PN/drreiujntvzfgwt4potj.png)
...
![](http://res.cloudinary.com/lesswrong-2-0/image/upload/v1672577367/mirroredImages/i3BTagvt3HbPMx6PN/pw7ttpv4gebkjkja9mls.png)
...
![](http://res.cloudinary.com/lesswrong-2-0/image/upload/v1672577367/mirroredImages/i3BTagvt3HbPMx6PN/v4y7w69r3qblijwfwxwd.png)
...
![](http://res.cloudinary.com/lesswrong-2-0/image/upload/v1672577367/mirroredImages/i3BTagvt3HbPMx6PN/urwsnk6sxtbqxs3wtdyj.png)
...
![](http://res.cloudinary.com/lesswrong-2-0/image/upload/v1672577367/mirroredImages/i3BTagvt3HbPMx6PN/dq0xsvfgv2qijp6biv1r.png)
...
![](http://res.cloudinary.com/lesswrong-2-0/image/upload/v1672577367/mirroredImages/i3BTagvt3HbPMx6PN/nfk5dnzxoiqf6lbb6ouk.png)
...
![](http://res.cloudinary.com/lesswrong-2-0/image/upload/v1672577367/mirroredImages/i3BTagvt3HbPMx6PN/wmrkq3k6jskgujfptzph.png)
...
![](http://res.cloudinary.com/lesswrong-2-0/image/upload/v1672577367/mirroredImages/i3BTagvt3HbPMx6PN/qepcfixlx0zhadqnx3iw.png)
...
![](http://res.cloudinary.com/lesswrong-2-0/image/upload/v1672577367/mirroredImages/i3BTagvt3HbPMx6PN/uaxabpb6vtkisvtbcca5.png)
...
![](http://res.cloudinary.com/lesswrong-2-0/image/upload/v1672577367/mirroredImages/i3BTagvt3HbPMx6PN/rtx157jrencl0lqy1ii8.png)
...
![](http://res.cloudinary.com/lesswrong-2-0/image/upload/v1672577367/mirroredImages/i3BTagvt3HbPMx6PN/wveer89r0x4jdx9mm5yn.png)

When we select actions from P at random, we can be sure regardless that there’s a low probability of high error.

![](http://res.cloudinary.com/lesswrong-2-0/image/upload/v1672577367/mirroredImages/i3BTagvt3HbPMx6PN/fcbtvggbxag0d2vnajlm.png)
...
![](http://res.cloudinary.com/lesswrong-2-0/image/upload/v1672577367/mirroredImages/i3BTagvt3HbPMx6PN/ti3n33imnwp4vkl2k7tk.png)
...
![](http://res.cloudinary.com/lesswrong-2-0/image/upload/v1672577367/mirroredImages/i3BTagvt3HbPMx6PN/ui8zqqspyly1shguzg5r.png)
...
![](http://res.cloudinary.com/lesswrong-2-0/image/upload/v1672577367/mirroredImages/i3BTagvt3HbPMx6PN/ivltzcrwdo3dguvzwzzk.png)
...
![](http://res.cloudinary.com/lesswrong-2-0/image/upload/v1672577367/mirroredImages/i3BTagvt3HbPMx6PN/awoaz6naslvacv4cised.png)
...
What we're primarily going to discuss in this section, though, is another problem: when the agent is made of parts, there could be [adversaries](https://www.lesswrong.com/w/nonadversarial) not just in the external environment, but inside the agent as well.
...
![](http://res.cloudinary.com/lesswrong-2-0/image/upload/v1672577367/mirroredImages/i3BTagvt3HbPMx6PN/k4rzduymyhtpa2ulthiz.png)
...
- *Robustness to scaling up* means that your system doesn’t stop behaving well if it gets better at optimizing. One way to check this is to think about what would happen if the function the AI optimizes were actually [maximized](https://www.lesswrong.com/w/omni_test). Think Goodhart's law.
...
![](http://res.cloudinary.com/lesswrong-2-0/image/upload/v1672577367/mirroredImages/i3BTagvt3HbPMx6PN/epfb4oatkx8bxgra4c3b.png)
...
![](http://res.cloudinary.com/lesswrong-2-0/image/upload/v1672577367/mirroredImages/i3BTagvt3HbPMx6PN/u8nradsj9o8az8nloszf.png)
...
In the long run, this process can go one step further. For a rich enough problem and an impressive enough search process, the solutions found via search might themselves be [intelligently optimizing](https://www.lesswrong.com/w/daemons) something.
...
Actually, to even use the term "distributional shift" seems wrong in the context of [embedded agency](https://www.lesswrong.com/posts/i3BTagvt3HbPMx6PN/intelligence.org?commentId=embedded-agency). The world is not [i.i.d.](https://en.wikipedia.org/wiki/Independent_and_identically_distributed_random_variables) The analog of "no distributional shift" would be to have an exact model of the whole future relevant to what you want to optimize, and the ability to run it over and over during training. So we need to deal with massive "distributional shift".
...
![](http://res.cloudinary.com/lesswrong-2-0/image/upload/v1672577367/mirroredImages/i3BTagvt3HbPMx6PN/eyskwoouo3dajginxpvd.png)
...
If we suppose all the other length-L programs are easy cases, there are exponentially many length-L programs, so the average is BB(L) / exp(L). But exponentials are computable. So BB(L) / exp(L) still grows faster than any computable function.
...
![](http://res.cloudinary.com/lesswrong-2-0/image/upload/v1672577367/mirroredImages/i3BTagvt3HbPMx6PN/xbqmmytryhd0fd1x1cqb.png)
...
[Bibliography](https://intelligence.org/embedded-agency/)