...
*Note: this text lived in a draft form before John Wentworth posted his* [*Case Against AI Control Research*](https://www.alignmentforum.org/posts/8wBN8cdNAv3c7vt6p/the-case-against-ai-control-research)*; my original intent was to extend it a bit more toward discussing AI control generalization properties. As this would be redundant now, I'm postin it as it is: there is some non-overlapping part.*